...
# Custom CSS to set the background color to blue
st.markdown(
    """
    <style>
    body {
        background-color: #D3D3D3; /* Blue color */
    }
...
#Footer
st.markdown("---")
st.markdown("""<p style= 'text-align: center;' >Powered by <b>Streamlit</b> and <b>Google Gemini AI</b> | Developed by <a href="https://www.linkedin.com/in/priyankakaushal0594"  target="_blank" style='text-decoration: none; color: ##007bff'><b>Priyanka Kaushal</b></a></p>""", unsafe_allow_html=True)